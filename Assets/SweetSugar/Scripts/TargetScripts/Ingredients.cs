    ...
    public class Ingredients : Target
    {
        ...
        public override void InitTarget(MLevelData mLevelData)
        {
            ...
            if (Application.isPlaying)
                fulledCountPerLevel = new int[MLevelManager.THIS.fieldBoards.Count];
...
//                        obj.DestroyBehaviour();
        ...
        public override bool IsTargetReachedSublevel()
        {
            if (fulledCountPerLevel.Length == 0)
                fulledCountPerLevel = new int[MLevelManager.THIS.fieldBoards.Count];
            return fulledCountPerLevel[MLevelManager.THIS.fieldBoards.FindIndex(x => x == MLevelManager.THIS.field)] >= GetDestinationCountSublevel();
        }
