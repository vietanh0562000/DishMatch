...
namespace SweetSugar.Scripts.TargetScripts.TargetSystem
{
    ...
    public abstract class Target
    {
        ...
        public abstract void InitTarget(MLevelData mLevelData);
        ...
        public void CheckItems(MItem[] items)
        {
            MLevelManager.THIS.mLevelData.TargetCounters.ForEachY(i=>i.CheckTarget(items));
        }

        public void CheckSquare(Square[] squares)
        {
            MLevelManager.THIS.mLevelData.TargetCounters.ForEachY(i=>i.CheckTarget(squares));
        }
