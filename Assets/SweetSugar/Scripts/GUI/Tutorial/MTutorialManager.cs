...
{
    public static List<MItem> items = new List<MItem>();
    ...
    void OnEnable()
    {
        ...
        MLevelManager.OnWaitForTutorial += Check;
        MLevelManager.OnSublevelChanged += Check;
        MLevelManager.OnStartPlay += DisableTutorial;
    }
    ...
    IEnumerator CheckTutorial()
    {
        ...
        if (tutorialType != null)
        {
            do
            {
                if (MLevelManager.THIS.gameStatus == GameState.ChangeSubLevel)
                ...
                if (items.Count > 0 && MLevelManager.THIS.gameStatus != GameState.ChangeSubLevel)
                {
    ...
    void CheckNewTarget(object tutorialType)
    {
        ...
        else if (MLevelManager.THIS.currentLevel < tutorials.Length && !showed)
        {
    ...
    private int SortByDistance(MItem item1, MItem item2)
    {
    ...
    public int FindMaxY(List<MItem> list)
    {
    ...
    {
        switch (MLevelManager.THIS.mLevelData.selectedTutorial)
        {
            case 1:
