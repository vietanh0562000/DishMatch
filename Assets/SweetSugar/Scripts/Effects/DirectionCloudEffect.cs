...
namespace SweetSugar.Scripts.Effects
{
    ...
    public static class DirectionCloudEffect
    {
        public static void SetGroupSquares(Square[] squaresArray)
        {
            ...
            groups.RemoveAll(i => i.Count() < MLevelManager.THIS.field.enterPoints);
            ...
            var list = squaresArray.Where(i => i.squaresGroup.Count < MLevelManager.THIS.field.enterPoints);
            groups.Clear();
