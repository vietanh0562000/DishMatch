...
namespace SweetSugar.Scripts.System.Orientation
{
    ...
    public class OrientationGameCameraHandle : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            MLevelManager.OnWaitForTutorial += OnSublevelChanged;
        ...
        void OnOrientationChanged(ScreenOrientation orientation)
        {
            ...
            if ((int)MLevelManager.THIS.gameStatus < 2) return;
        ...
        IEnumerator OrientationChangeDelay()
        {
            ...
            if (MLevelManager.THIS.gameStatus != GameState.ChangeSubLevel && MLevelManager.THIS.gameStatus != GameState.WaitForPopup)
        ...
        public CameraParameters GetCameraParameters()
        {
            ...
            {
                var fieldRect = MLevelManager.THIS.field.GetFieldRect();
                ...
                cameraParameters.position = MLevelManager.THIS.field.GetPosition() + offsetPosition;
            }
            ...
            if (currentOrientation == ScreenOrientation.Portrait)
            {
                ...
                var offsetPosition = (Vector2)mainCamera.ScreenToWorldPoint(centerRect.center) -
                                     (Vector2)mainCamera.ScreenToWorldPoint(new Vector2(Screen.width / 2f,
                                         Screen.height / 2f));
                cameraParameters.position = MLevelManager.THIS.field.GetPosition() + offsetPosition - offsetFieldPosition;
            }
