...
namespace SweetSugar.Scripts.GUI
{
    ...
    {
        DisableImages();
        var levelData = new MLevelData(Application.isPlaying, MLevelManager.THIS.currentLevel);
        levelData = MLoadingManager.LoadForPlay(PlayerPrefs.GetInt("OpenLevel"), levelData);
